...
private:
    ...
    std::shared_ptr<GL::MShaderEffect> tubeTimeShader;
    std::shared_ptr<GL::MShaderEffect> tubeTimeShadowShader;
    ...
    float       sphereRadius;
    QtProperty *tubeMinRadiusProperty;
    float       tubeMinRadius;

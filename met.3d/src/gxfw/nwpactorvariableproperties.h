...
/**
  Actor for gradient filter
  */
class MGradientProperties : public MRequestProperties
{
public:
    MGradientProperties(MNWPActorVariable *actorVar);
    ~MGradientProperties();
    bool onQtPropertyChanged(QtProperty *property,
                             bool *redrawWithoutDataRequest);
    void addToRequest(MDataRequestHelper *rh);
     ...
     * @return smooth mode name as string.
     */
    static QString gradientModeToString(GradientModeTypes smoothMode);
     ...
     * @return the smooth mode as enum item.
     */
    static MGradientProperties::GradientModeTypes stringToGradientMode(
            QString smoothMode);
protected:
    QtProperty *recomputeOnPropertyChange;
    QtProperty *applySettingsProperty;
    QtProperty *gradientModeProperty;
private:
    GradientModeTypes gradientMode;
    QtProperty *groupProperty;
};

/**
  Actor for vector magnitude filter
  */
class MVecMagProperties : public MRequestProperties
{
public:
    MVecMagProperties(MNWPActorVariable *actorVar);
    ~MVecMagProperties();
    bool onQtPropertyChanged(QtProperty *property,
                             bool *redrawWithoutDataRequest);
    void addToRequest(MDataRequestHelper *rh);
...
protected:
    QtProperty *recomputeOnPropertyChange;
    QtProperty *applySettingsProperty;
    QtProperty *vecMagModeProperty1;
    QtProperty *vecMagModeProperty2;
private:
    MGradientProperties::GradientModeTypes gradientMode1;
    MGradientProperties::GradientModeTypes gradientMode2;
    QtProperty *groupProperty;
};

...
MDataRequestHelper MNWPActorVariable::constructAsynchronousDataRequest()
{
    // Request grid.
    // ===================================================================
...
void MNWPActorVariable::asynchronousDataRequest(bool synchronizationRequest)
{
    ...
    MDataRequestHelper rh = constructAsynchronousDataRequest();
...
//    QString filename = QString("cross_section_grid_%1_hPa_%2.met3d.nc")
//            .arg(variableName, validTimeProperty->valueText());
//    if (targetGrid2D)
//    {
...
void MNWP2DHorizontalActorVariable::dataFieldChangedEvent()
{
    ...
    // TODO: Remove this part of code if finished
    // here auto save horizontal cross section
    // Click on button "save" --> trigger a saveAsNetCDF() call for the
    // target grid.
//    LOG4CPLUS_DEBUG(mlog, "Saving cross-section grid.." << flush);

...
shader VStubeSimple3D(in vec3 pos : 0,
                      in float tfp : 1,
                      in float abz : 2,
                      in float strength : 3,
                      in float type : 4,
...
shader VStubeSimpleShadow3D(in vec3 pos : 0,
                            in float tfp : 1,
                            in float abz : 2,
                            in float strength : 3,
                            in float type : 4,
...
shader FStubeOIT(in GStoFS Input, out vec4 fragColor)
{
    ...
    vec3 shadingColor;
    getBlinnPhongColor(Input.worldPos, Input.normalPS, shading, shadingColor);
...
program TubeFilteringOIT3D
{
    vs(430)=VStubeSimple3D();
    gs(430)=GStube() : in(lines_adjacency), out(triangle_strip, max_vertices = 128);
    fs(430)=FStubeOIT() : in(early_fragment_tests);
};

program TubeFilteringShadowMap3D
{
    vs(430)=VStubeSimple3D();
    gs(430)=GStube() : in(lines_adjacency), out(triangle_strip, max_vertices = 128);
    fs(430)=FStubeOIT();
...
program TubeFilteringShadow3D
{
    vs(430)=VStubeSimpleShadow3D();
    gs(430)=GStube() : in(lines_adjacency), out(triangle_strip, max_vertices = 128);
    fs(430)=FStubeShadow() : in(early_fragment_tests);
};

...
**
*******************************************************************************/
#ifndef GRADVECMAGPIPELINEFILTER_H
#define GRADVECMAGPIPELINEFILTER_H
...
class MGradVecMagPipelineFilter
        : public MSingleInputProcessingWeatherPredictionDataSource
{
public:
    MGradVecMagPipelineFilter();
    ~MGradVecMagPipelineFilter();
...
#endif // DEBUGVECMAGVECMAGFILTER_H

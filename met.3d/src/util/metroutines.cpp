...
extern "C" {
void ddh3_(float *a, float *d, float *ps, float *dps, float *cl,
          int *dir, int *ie, int *je, int *ke, float *datmin,
          float *datmax, float *ak, float *bk);
}
void horizontalGradient_calvar(
        float *a, float *d, float *ps, float *dps, float *cl,
        int dir, int ie, int je, int ke, float *datmin,
        float *datmax, float *ak, float *bk)
{
    ddh3_(a, d, ps, dps, cl, &dir, &ie, &je, &ke, datmin, datmax, ak, bk);
}

...
int main(int argc, char *argv[])
{
    ...
    // Register QList<MTask*> as meta type to enable signal/slot processing

    // Used for GPU Task processing with multi-threading enabled

    // sqRegisterMetaType<QList<Met3D::MTask*>>("QList<MTask*>");

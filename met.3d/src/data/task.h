...
/**
  ...
  */
class MTask : public QObject
{
Q_OBJECT
public:
    MTask(MDataRequest request, MScheduledDataSource* dataSource,
          bool valid=true, QObject *parent = nullptr);
    ...
    void setGPUTask() { gpuTask = true; involvesGPUTasks = true;}
    ...
    bool dependsOnGPUTasks() const { return involvesGPUTasks; }
...
signals:
    //void gpuTaskProcessable(QList<MTask*> gpuTasks);
    void gpuTaskProcessable(MTask* gpuTask);

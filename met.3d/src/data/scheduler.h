...
class MMultiThreadScheduler : public MAbstractScheduler
{
    Q_OBJECT
public:
    MMultiThreadScheduler(QObject *parent = nullptr);
...
private slots:
    void processGPURequest(MTask* task);

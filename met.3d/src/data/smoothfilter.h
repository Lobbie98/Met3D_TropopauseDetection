...
//*************************** GAUSSIAN SMOOTHING *******************************
    ...
    //Julian M: ExponentialFilter vertikal anwenden
     ...
     */
    QList<QList<double>> precomputeLatDependendDistanceWeightsOfLongitude(
     ...
     */
    QList<double> precomputeDistanceWeightsOfLatitude(
            const MStructuredGrid *inputGrid, double stdDev_km);
     ...
     */
    double computeGaussWeight(double stdDev_km, double distance_km);
...
//*************************** BOX BLUR SMOOTHING *******************************
    ...
    QList<QList<int>> computeLatDependentBoxRadii(
            const MStructuredGrid *inputGrid, double stdDev_km, int n);
    ...
    int numGridpointsSpannedByDistance(
            const MStructuredGrid *inputGrid, int jLat, double distance_km);
     ...
     * conditions.
     */
    QVector<int> createIndexList(
            const MStructuredGrid *inputGrid, const int boxRadius,
            const QString dir);
...
//*************************** UNIFORM WEIGHTED SMOOTHING ***********************
     ...
     * @param radius_gp radius in grid points (in GUI standard deviation)
     */
    void computeHorizontalUniformWeightedSmoothing_GCGridpoints_GPU(
            const MStructuredGrid *inputGrid, MStructuredGrid *resultGrid,
            int radius_gp);

        ...
        int numFiles, QString labelText)
{
    ...
    {
        // qApp->processEvents() needs to be called to update what is shown
        // of the dialog.
        // Check for applicationIsInitialized() is necessary because:
        // At least for Qt versions >= 5.12 (didn't encounter that before,
        // mr 23Sept2021), when the "--pipeline=.." argument is passed on the
        // command line, processEvents() triggers initialization of
        // MSceneViewGLWidgets BEFORE glRM is initialized -> seg fault.
        qApp->processEvents();
    }
}

...
{
    //MKM Proj 8 lib PJ_INFO *proj_info = proj_info(); // to get Proj version info.
    const char *projversion = (proj_info()).version;
    ...
    QString aboutString = QString(
            ...
            "<a href='https://collaboration.cen.uni-hamburg.de/display/Met3D'>online "
            ...
            "Copyright 2015-2021 Met.3D authors:<br>"
            "Marc Rautenhaus(*, +[until 2018]), Bianca Tost(+), Michael Kern(+), "
            "with contributions by Kameswarrao Modali(*), Andreas Beckert(*), Marcel Meyer(*), "
            "Alexander Kumpf(+), Philipp Kaiser(+), "
            "Fabian Sch&ouml;ttl(+), Christoph Heidelmann(+).<br><br>"
            "(*) <a href='https://uhh.de/rrz-research'>Visual Data Analysis Group, "
            "Regional Computing Center</a>, "
            "Universit&auml;t Hamburg, Hamburg, Germany<br>"
            "(+) <a href='https://www.in.tum.de/cg/'>Computer Graphics and "

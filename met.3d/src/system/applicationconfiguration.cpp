...
#include "fronts/frontdetectionactor.h"
#include "tropopause/tropopausedetectionactor.h"
...
void MApplicationConfigurationManager::registerActorFactories()
{
    ...
    glRM->registerActorFactory(new MFrontDetectionActorFactory());
    //Julian M: Den Actor auswählbar machen. Muss drin bleiben
    glRM->registerActorFactory(new MTropopauseDetectionActorFactory());
}

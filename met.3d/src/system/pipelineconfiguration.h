...
//Julian M: Wird für den Dummyfilter benötigt. Kann dann auch raus.
#include "data/scheduleddatasource.h"
#include "data/structuredgrid.h"
#include "mainwindow.h"

//Julian M: Wird auch für die Ableitungen auf dem Skew-T benötigt
...
//Julian M: DummyFilter. Kann auch raus, wenn man die Ableitungen nicht auf dem Skew-T sehen will.
class MDummyFilter2: public MSingleInputProcessingWeatherPredictionDataSource
{
public:
    MDummyFilter2(int multiplikation);
